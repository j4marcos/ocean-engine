...
void rasterScene() {
    ...
    // renderizando luzes do dia/noite
    DayNightLighting dn;
    ...
    // renderizando modelo da câmera
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();

    // renderizando vetor da câmera
    ...
    // renderizando caixas - solid (torre do farol, placas da cabeça, carros, etc.)
